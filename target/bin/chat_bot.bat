...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="chat_bot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" chatBot.TelegramProgram %CMD_LINE_ARGS%
